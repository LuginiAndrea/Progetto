...
/******************** CONSTANTS ***********************/
const monument_types_router: Router = Router();
...
/****************************************** ROUTES **********************************************/
monument_types_router.options("/", (req, res) => {
    const method_list = [
