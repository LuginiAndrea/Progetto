...
exports.is_monument_types_body = exports.is_types_of_monuments_body = exports.is_visits_body = exports.is_monuments_body = exports.is_users_body = exports.is_languages_body = exports.is_cities_body = exports.is_countries_body = exports.extract_fields = exports.get_fields = void 0;
...
var extract_fields = function (body, fields, no_id) {
    if (no_id === void 0) { no_id = true; }
    return fields.filter(function (x) { return !(x === "id" && no_id); }).map(function (field) { return body[field]; });
};
exports.extract_fields = extract_fields;
