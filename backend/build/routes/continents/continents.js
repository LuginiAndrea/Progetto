...
continents_router.get("/all_continents", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
...
continents_router.get("/single_continents/:continent_id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, new DB_interface_1.DB_interface({
