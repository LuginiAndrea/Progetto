...
describe("Benchmarks tests", function () {
    ...
    describe("Specific api tests", function () {
        ...
        describe("Markers", function () {
            it("Markers by distance", function () { return __awaiter(void 0, void 0, void 0, function () {
                var distance, latitude, longitude, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            distance = 3000;
                            ...
                            return [4 /*yield*/, request.get("/monuments/markers_by_distance?distance=".concat(distance, "&latitude=").concat(latitude, "&longitude=").concat(longitude))];
                        case 1:
                            response = _a.sent();
                            expect(response.status).toBe(200);
                            response.body = response.body[0];
