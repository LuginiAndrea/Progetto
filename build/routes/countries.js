...
countries_router.get("/routes", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var routes;
    return __generator(this, function (_a) {
        routes = [
            ...
            { method: "GET", path: "/filter_by_single_iso_code/:country_iso_code", body: "NO", is_admin: false },
            { method: "GET", path: "/filter_by_continents", body: "Query_String", is_admin: false },
...
/************************************** GET ***************************************************/
countries_router.get("/all", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
countries_router.get("/filter_by_id", utils_1.validate_ids, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var db_interface, language, fields, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
...
countries_router.get("/filter_by_continents", utils_1.validate_ids, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var db_interface, language, fields, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
            ...
            case 1:
                ...
                _a = utils_1.send_json;
                _b = [res];
                return [4 /*yield*/, utils_3.values.get.generic(table_name, db_interface, fields, "".concat(join_fields_query, " WHERE fk_continent_id = ANY ($1)"), [res.locals.ids])];
            case 2:
                _a.apply(void 0, _b.concat([_c.sent()]));
                return [2 /*return*/];
        }
...
countries_router.get("/filter_by_cities", utils_1.validate_ids, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var db_interface, language, fields, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
            ...
            case 1:
                ...
                _a = utils_1.send_json;
                _b = [res];
                return [4 /*yield*/, utils_3.values.get.generic(table_name, db_interface, fields, "".concat(join_fields_query, " WHERE id = ANY (SELECT fk_country_id FROM cities WHERE id = ANY ($1))"), [res.locals.ids])];
            case 2:
                _a.apply(void 0, _b.concat([_c.sent()]));
                return [2 /*return*/];
        }
